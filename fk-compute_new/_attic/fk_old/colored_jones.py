"""
Colored Jones polynomial for braids
based on https://github.com/jsflevitt/color-Jones-from-walks
based on https://arxiv.org/abs/1804.07910
Python implementation by Toby Saunders-A'Court
"""
...
def colored_jones_coefficients(braid,color):
    return tuple(format(Jones(braid, N=color, mirror_optimization=True)))

if __name__ == '__main__':

    braid_word = [-1,2,3,1,3,2,-1,2,3,1,2,-1,2] # 12n_293
    ...
    #braid_word = [1, 1, 2, -1, 2, 2, 3, -2, -2, 4, -3, 2, 4, 3] # 9_35
    #braid_word = [-1, -1, -1]
    ##braid_word = [1, 1, 1]
    ...
    print(format(Jones(braid_word, N=7, mirror_optimization=True)))
