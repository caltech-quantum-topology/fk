...
// procedure for implementing negative powers of x and y:
//      1. specify negative degree bound in braid_ilp file
//      2. solve in solution_pool
//      3. create acc vectors with 2**(n_components) times the size as before
//      4. make sure acc indexing still is correct
//
//
//
//
