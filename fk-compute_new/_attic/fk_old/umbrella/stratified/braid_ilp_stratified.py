...
def print_unreduced(relations, braid_states):
    ...
    criteria, _, singlesigns = process_assignment(assignment, braid_states, relations)
    print("\nMinimal x-Degree:\n")
...
def save(braid_states : BraidStates, degree, save_to):
    """
